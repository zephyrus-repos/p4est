...
int main(int argc, char **argv) {
   ...
   * from processor zero.  Here we turn off most of the logging; see sc.h. */
    ...
    P4EST_GLOBAL_PRODUCTIONF("This is the p4est %dD demo example/steps/%s_step2\n", P4EST_DIM, P4EST_STRING);

    /* Get the .inp file name from the list of arguments along with an optional level of refinement. */
    if (argc != 2 && argc != 3) {
    ...
    */
    ...
    p4est_vtk_write_file(p4est, NULL, P4EST_STRING "_start");
